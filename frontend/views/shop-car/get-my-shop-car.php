...
<?php $form = ActiveForm::begin([
      'action'=>['order-new/pay-order-shop'],
 ...
 <h4 class="reg_txt sure_address">确认收货地址</h4>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="middle"><img src="<?=$v['goods_img'] ?>" width='50' height='50' alt=""></td>
      <td align="center" valign="middle"><?php echo $v['goods_name'] ?></td>
      <td align="center" valign="middle"><?php echo $v['present_price'] ?></td>
      <td align="center" valign="middle"><?php echo $v['goods_num'] ?></td>
      <td align="center" valign="middle"><?php echo $v['present_price']*$v['goods_num'] ?></td>
   ...
   <div class="clear_order_cart"><a href="<?php echo Url::to(['goods/index']) ?>" class="back_link"><button type="button">返回购物车</button></a></div>
     ...
     <div class="buy_now_box">
      ...
      <p>商品总数：<strong><?php echo $goods_sum_num ?></strong></p>
      <p>商品总金额：<em><?php echo $goods_sum_money ?></em> 元</p>
