...
use common\models\ParameterSearch;
 ...
 */
class ParameterController extends LdBaseController
{
    /**
     * @inheritdoc
     */
    ...
    {
        $model = Parameter::find()->where(['id'=>$id])->select('id,val')->one();
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['index']);
            // return null;
        } else {
            return $this->renderAjax('update-val',['model'=>$model]);
        }
    }
